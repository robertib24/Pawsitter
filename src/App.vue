...
// Conține navbar-ul, dark mode toggle, toast container și router-view
...
// Composable pentru gestionarea temei dark/light
// Persistat automat în localStorage
...
<template>
  <div class="min-h-screen bg-base-200 flex flex-col">
    ...
    >
      ...
      <div class="navbar-end gap-2">
        ...
        <button
          ...
          v-tooltip:bottom="isDark ? 'Mod luminos' : 'Mod întunecat'"
        >
          <transition name="theme-toggle" mode="out-in">
            <svg v-if="isDark" key="sun" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
            </svg>
            <svg v-else key="moon" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <!-- Toast notifications globale — montate o singură dată în App -->
    <ToastContainer />
  </div>
</template>

<style scoped>
/* Animație rotire iconițe theme toggle */
